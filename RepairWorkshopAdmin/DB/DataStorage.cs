...
namespace RepairWorkshopAdmin.DB
{
    public static class DataStorage
    {
        ...
        public async static Task<List<Order>> GetAllOrders()
        {
            using (var context = new RepairWorkshopContext())
        ...
        #region Send things
        /// <summary>
        /// Versatile adding class. You can use others but I plan to remove them
        /// </summary>
        /// <param name="entity"></param>
        /// <returns></returns>
        public async static Task<bool> TryAddEntity(object entity)
        {
            using (var context = new RepairWorkshopContext())
            {
                if (entity == null)
                ...
                if (entity is Employee)
                    context.Employees.Add(entity as Employee); 
                else if (entity is Order)
                    context.Orders.Add(entity as Order);
                else if (entity is Price)
                    context.Prices.Add(entity as Price);
                else if (entity is Receip)
                    context.Receips.Add(entity as Receip);
                else if (entity is TechOwner)
                    context.TechOwners.Add(entity as TechOwner);
                else if (entity is TechType)
                    context.TechTypes.Add(entity as TechType);
        ...
        public async static Task<bool> TryAddEmployeeAsync(Employee emp)
        {
            using (var context = new RepairWorkshopContext())
            {
